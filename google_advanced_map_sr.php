...
<html>
  ...
  <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta.2/css/bootstrap.min.css" integrity="sha384-PsH8R72JQ3SOdhVi3uxftmaW6Vc51MKb0q5P2rRUpPvrszuE4W1povHYgTpBfshb" crossorigin="anonymous">
	  ...
	  script.src = 'geojson_shared_room.php';
    ...
    <script>
      ...
      function initMap() {
        ...
        map.data.setStyle(styleFeature);
		 ...
		 map.data.loadGeoJson('geojson_shared_room.php');
	 ...
	 // Average price is calculared by (newPrice + newPrice) / 2. On geojson_shared_room.php file
        ...
        legend.id = 'legend';
        var content = [];
        content.push('<h3>Shared rooms average listing prices</h3>');  
        content.push('<p><div class="color strong_green"></div>$ 44</p>');
        content.push('<p><div class="color green"></div>$ 75</p>');
        content.push('<p><div class="color green_avocado"></div>$ 106</p>');
        content.push('<p><div class="color light_brown"></div>$ 137</p>');
        content.push('<p><div class="color light_red"></div>$ 170</p>');
