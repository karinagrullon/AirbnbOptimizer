...
<p>in order to get a weekly price estimation for your new property.</p>
</div>
...
<form action= '' method='GET'>  
  ...
  <br> <br>
  <input type="submit" class="btn btn-warning" value="Estimate"> <a href="price_estimation.php"><input class="btn btn-info" type="button" value="Clear"></a>
</form> 
<br>
</div>
<?php
...
echo 'The weekly average income you can make with Airbnb is: $';
echo  round($wk_price);
