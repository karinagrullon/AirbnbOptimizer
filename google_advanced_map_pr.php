...
<html>
  ...
  <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-beta.2/css/bootstrap.min.css" integrity="sha384-PsH8R72JQ3SOdhVi3uxftmaW6Vc51MKb0q5P2rRUpPvrszuE4W1povHYgTpBfshb" crossorigin="anonymous">
	  ...
	  script.src = 'geojson_private_room.php';
 ...
 <!-- End menu -->
    ...
    <script>
      ...
      function initMap() {
        map = new google.maps.Map(document.getElementById('map'), {
		 ...
		 map.data.loadGeoJson('geojson_private_room.php');
	 ...
	 // Average price is calculared by (newPrice + newPrice) / 2. On geojson_shared_room.php file
        ...
        legend.id = 'legend';
        var content = [];
        content.push('<h3>Private rooms average listing prices</h3>');  
        content.push('<p><div class="color strong_green"></div>$ 86</p>');
        content.push('<p><div class="color green"></div>$ 105</p>');
        content.push('<p><div class="color green_avocado"></div>$ 141</p>');
        content.push('<p><div class="color light_brown"></div>$ 137</p>');
        content.push('<p><div class="color light_red"></div>$ 159</p>');
    ...
    <script async defer
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDhhpTLe6JUY_Ofagp_ePRMelZUrepiywQ&callback=initMap"">
    </script>
